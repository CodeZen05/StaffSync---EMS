        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          {error && (
            <div className='mb-6 p-4 bg-rose-50 border border-rose-200 text-rose-700 text-sm rounded-xl flex items-start gap-3'>
              <div className='w-1 h-1.5 rounded-full bg-rose-500 mt-1.5 shrink-0' />
              {error}
            </div>
          )}
          ...
          <form className='space-y-5' onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                className='w-full px-4 py-2.5 border border-slate-200 rounded-lg text-sm text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent transition'
              />
            </div>
            ...
            <div>
              ...
              <div className='relative'>
                <input
                  ...
                  required
                  placeholder='••••••••'
                  className='w-full px-4 py-2.5 pr-11 border border-slate-200 rounded-lg text-sm text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent transition'
                />
                <button
                  type='button'
